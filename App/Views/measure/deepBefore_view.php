...
<div class="card col-sm-12">
    ...
    <div class="col-lg-7 m-auto d-flex justify-content-center align-items-center">
        ...
        <div data-href="<?= $this->route->baseUrl() . 'DeepTrack'?>" id="counter" class="text-success"></div>
    </div>
    ...
    <div class="card-body col-sm-10 m-auto answer_form">
        ...
        foreach ($questions as $question) {
            ...
            <form action="<?= $this->route->baseUrl() . 'measure/examAdd'?>" method="post" id="form_<?= $question->question_id?>" class="form_<?= $question->question_id?> mb-5 d-none">
                <input type="hidden" name="model" value="AnswersDeepBeforeModel">
                <input type="hidden" name="table" value="answers_before_deep">
                ...
                foreach ($choices as $choice) {
                    ...
                    $sql = "SELECT * FROM answers_before_deep WHERE question_id = $queId AND student_id = $sId";
        ...
        <?php } ?>
        <a href="<?= $this->route->baseUrl() . 'deepTrack'?>" class="btn btn-success text-light text-uppercase mb-5 d-none save_surface_answer">Save answers</a>
    </div>
